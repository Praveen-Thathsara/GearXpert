...
export function CustomerRequest() {
  ...
  const validateForm = () => {
    ...
    if (!formData.location.trim()) {
      errors.location = "Location (City/Town) is required";
    }
      ...
      <div className="grid lg:grid-cols-3 gap-8 md:gap-12">
        ...
        <div className="lg:col-span-2">
          <h1 className="text-3xl font-extrabold text-zinc-100 mb-2">
            Complete Your Parts Request
          </h1>

          <p className="text-zinc-400 mb-8 text-lg">
            Please provide your contact details so our team can reach out to
            you with pricing and availability confirmation.
          </p>
          ...
          <form
            ...
            className="space-y-8 bg-zinc-900 p-6 md:p-8 rounded-sm shadow-none border border-zinc-800"
          >
                ...
                <div>
                  ...
                  <div className="flex">
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`flex-1 min-w-0 block px-4 py-3 rounded-none rounded-r-sm border ${
            ...
            <div className="space-y-6 pt-4">
              <h3 className="text-xl font-bold border-b border-zinc-800 pb-2 text-zinc-400">
                Optional Details
              </h3>
        ...
        <div className="lg:col-span-1">
          <div className="bg-zinc-950 rounded-sm p-6 border border-zinc-700 sticky top-24">
            ...
            <h3 className="font-bold text-zinc-100 mb-4 pb-4 border-b border-zinc-700">
              Request Items ({getCartItemCount()})
            </h3>
            ...
            <div className="mt-6 pt-4 border-t border-zinc-700 text-sm text-zinc-400">
              By submitting this request, you agree that our team will contact
              you regarding availability and final pricing for the listed
              items.
            </div>
          </div>
        </div>
